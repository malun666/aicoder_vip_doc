...
<img src="../image/img/canvas-x-y.png" height="532" width="730">
...
<img src="../image/img/fill-0-prin.jpg" height="206" width="289">
...
![设置文字为主](../image/img/font-line1.png)

<img src="../image/img/textBaseline.gif" height="268" width="300" alt="">
...
- JS 的构造函数的原型
  ...
  <img src="../image/img/prototype.png" height="763" width="872" alt="">
...
- lineCap 设置或返回线条的结束端点(线头、线冒)样式
  ...
  - square： 向线条的每个末端添加正方形线帽。  
    <img src="../image/img/linecap.png" height="303" width="480" >  
    参考：23 线的样式.html
- lineJoin 设置或返回两条线相交时，所创建的拐角类型
  ...
  - round: 创建圆角。 \* miter: 默认。创建尖角  
    <img src="../image/img/linejoin.png" height="387" width="453" alt="">

- lineWidth 设置或返回当前的线条宽度
- miterLimit 设置或返回最大斜接长度
  - 意思: 斜接 英 ['maɪtə]
  - 斜接长度指的是在两条线交汇处内角和外角之间的距离。 \* 一般用默认值：10 就可以了。除非需要特别长的尖角时，使用此属性。
    <img src="../image/img/MiterLimet.png" height="410" width="840" alt="">
...
- 参数：
  ...
  - `x` ： 结束点的 x 坐标
  - `y` ： 结束点的 y 坐标  
  <img src="../image/img/quadraticcurve.gif" height="140" width="258" alt="">
...
- 案例：25 绘制贝塞尔曲线.html  
  <img src="../image/img/beziercurve.gif" height="166" width="290" alt="">
...
<img src="../image/img/canvas-arcto-1.png" height="311" width="427" alt="">
...
- 圆形上面的点的坐标的计算公式
  ...
  <img src="../image/img/圆形点的坐标计算公式.png" height="581" width="830" alt="">
