...
JavaScript 允许采用`\uxxxx`形式表示一个字在`\u0000`~`\uFFFF`之间的字符，其中`xxxx`表示字符的 Unicode 码点。
...
[中文unicode编码表](http://www.qqxiuzi.cn/zh/hanzi-unicode-bianma.php)

[中文与unicode转换工具](http://tool.chinaz.com/tools/unicode.aspx)
